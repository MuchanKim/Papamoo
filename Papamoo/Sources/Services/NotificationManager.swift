...
struct NotificationManager {
    ...
    static func rescheduleAll(in context: ModelContext) throws {
        ...
        // NotificationManager owns every local notification currently created by the app.
        // Clearing first also removes identifiers generated by a previous process's hash seed.
